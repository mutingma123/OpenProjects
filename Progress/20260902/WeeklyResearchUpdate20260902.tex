...
\newcommand{\projectline}[1]{%
  \noindent\colorbox{uablue!7}{%
    \parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
      \footnotesize\textbf{Name:} Muting (Don) Ma\hfill
      \textbf{Project:} #1\hfill
      \textbf{Date:} September 2, 2026}}
  \vspace{0.3em}}
...
\begin{center}
  \href{https://github.com/mutingma123/OpenProjects/blob/main/EmbeddingRetrievalLimitations/Figures/RetrievalCapacityMap.png}{%
    \includegraphics[width=\linewidth]{../../EmbeddingRetrievalLimitations/Figures/RetrievalCapacityMap.png}}

  \scriptsize\textcolor{sectiongray}{Evidence chain and proposal transfer}
\end{center}
...
\artifact{https://github.com/mutingma123/OpenProjects/tree/main/EmbeddingRetrievalLimitations/Figures}{selected snapshot}.
\end{minipage}
...
\begin{center}
  \href{https://github.com/mutingma123/OpenProjects/blob/main/BiObjectiveRevisionC1/Figures/ExpectedCollisionCost.png}{%
    \includegraphics[width=\linewidth]{../../BiObjectiveRevisionC1/Figures/ExpectedCollisionCost.png}}

  \scriptsize\textcolor{sectiongray}{Adopted least-gap cost construction}
\end{center}
...
\artifact{https://github.com/mutingma123/OpenProjects/tree/main/BiObjectiveRevisionC1/Figures}{selected snapshot}.
\end{minipage}
...
\begin{center}
  \href{https://github.com/mutingma123/OpenProjects/blob/main/StochasticMultipleKnapsack/Figures/ManuscriptFinalVerdict.png}{%
    \includegraphics[width=\linewidth]{../../StochasticMultipleKnapsack/Figures/ManuscriptFinalVerdict.png}}

  \scriptsize\textcolor{sectiongray}{Current technical and editorial verdict}
\end{center}
...
\artifact{https://github.com/mutingma123/OpenProjects/tree/main/StochasticMultipleKnapsack/Figures}{selected snapshot}.
\end{minipage}
